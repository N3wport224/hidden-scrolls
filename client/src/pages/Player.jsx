...
export default function Player() {
  ...
  const [sessionId, setSessionId] = useState(null); // The key to fixing the 404
      ...
      <div className="w-full max-w-3xl flex flex-col items-center">
        ...
        <div className="w-full bg-slate-800 p-6 rounded-xl shadow-lg mb-8">
            <audio 
              ref={audioRef} 
              controls 
              key={sessionId} // Forces reload once ID is ready
            ...
            {!sessionId && <p className="text-center text-xs text-yellow-500 mt-2 italic">Waiting for Secure Handshake...</p>}
        </div>
